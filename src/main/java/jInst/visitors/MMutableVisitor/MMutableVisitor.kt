package jInst.visitors.MMutableVisitor

import kastree.ast.Node

open class MMutableVisitor {
    ...
    companion object {
        fun <T: Node> preVisit(v: T, fn: (v: Node?, parent: Node) -> Node?) = object : MMutableVisitor() {
            override fun <T : Node?> preVisit(v: T, parent: Node): T = fn(v, parent) as T
        }.visit(v, v)

        fun <T: Node> postVisit(v: T, fn: (v: Node?, parent: Node) -> Node?) = object : MMutableVisitor() {
